...
const ClinicalTHTPopup = ({ setPopup2 }) => {
    ...
    return (
        <div className="fixed flex items-center justify-center inset-0">
            <div className="fixed top-0 left-0 w-screen h-screen bg-[#0000006e]" onClick={() => setPopup2(false)}></div>
            <div className="max-w-[90%] w-full bg-white border border-[#CFD1D4] z-10 rounded-lg ">
                <div className="flex items-center justify-between p-4 ">
                    ...
                    {
                        previewDocument ? (
                            <MdClose className='text-[#9F9FA1] text-2xl cursor-pointer' onClick={() => setPopup2(false)} />
                        ) : (
                            <PiArrowsOutSimpleBold className='text-[#9F9FA1] text-2xl cursor-pointer' onClick={() => setPopup2(false)} />
                        )
                    }
                </div>
